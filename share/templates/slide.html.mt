? my ($filename, $theme, $transition, $size, $lang) = @_;
<!doctype html>
<html lang="en">
  <head>
    <meta charset="utf-8">
    ...
    <script>
      Reveal.initialize({
        ...
        dependencies: [
          ...
          { src: 'notes-speech/plugin/notes-speech/notes-speech.js', async: true, condition: function() { return !!document.body.classList; } }
        ]
      });
    </script>
  </body>
